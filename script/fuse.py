...
def main():
    ...
    if args.output_model is None:
        ...
        args.output_model = root + + 'TestModel_inference.prototxt'
    if args.output_weights is None:
        file_name = osp.splitext(args.weights)[0]
        args.output_weights = root + 'TestModel_inference.caffemodel'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="../models/TestModel_svd.prototxt", help="The net definition prototxt")
    parser.add_argument('--weights', default="../models/TestModel_svd.caffemodel", help="The weights caffemodel")
